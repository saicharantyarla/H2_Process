...
my $sub="Oracle Upgradation- PostCheckCompleted";
...
if (@ARGV == 11)
{
my	$hcon="<!DOCTYPE html><html lang=\"en\"><body><p>Hi Team,</p><p>This is to inform that  the ORACLE Upgradation process completed on the server $ORACLEServer.</p><br><p>Also find the status of the PostChecks that this process went through.</p><table align=\"left\" border=\"1\" cellpadding=\"1\" cellspacing=\"1\" dir=\"ltr\" style=\"width:60%;\">    <thead>    <tr>        <th scope=\"col\" style=\"text-align: left; vertical-align: middle; background-color: rgb(0, 51, 102);\"><span style=\"color:#FFFFFF;\">Components</span></th><th scope=\"col\" style=\"text-align: left; vertical-align: middle; background-color: rgb(0, 0, 102);width: 60%;\"><span style=\"color:#FFFFFF;\">Values</span></th></tr></thead><tbody>
 <tr>
<td> Execute Postupgrade Fixup</td>
<td>${ScriptDesc1}</td>
</tr> 
<tr> 
<td> Execute UTLRP(PostUpgrade)</td>
<td>${ScriptDesc2}</td>
</tr> 
<tr>
<td> Fetch Invalid Object(s) (PostUpgrade)</td>   
<td>${ScriptDesc3}</td>
</tr>
<tr>
<td>Compare Precheck and Postcheck Invalid Object</td>                
<td>${ScriptDesc4}</td>
</tr>
<tr>  
<td>Oratab Updation</td>              
<td>${ScriptDesc5}</td>
</tr>
<tr>
<td>Version Check</td>
