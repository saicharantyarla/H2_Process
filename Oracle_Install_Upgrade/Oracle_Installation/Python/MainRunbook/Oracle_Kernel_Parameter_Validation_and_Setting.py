...
if len(sys.argv) == 10:
    ...
    #Connectivity Test #
    HLStatus.UpdateHLStatus(APID,"Stepid96","In Progress","Oracle Kernel Parameter set is In Progress",LogServer,LogDB,LogUser,LogPassword)
    ...
    try:
        ...
        if '1' not in count:
            ...
            HLStatus.UpdateHLStatus(APID,"Stepid96","Failed","Oracle Kernel Parameter Validation Failed",LogServer,LogDB,LogUser,LogPassword)
        ...
        HLStatus.UpdateHLStatus(APID,"Stepid96","Failed","Oracle Kernel Parameter Script Failed due to soome exception",LogServer,LogDB,LogUser,LogPassword)
    finally:
        s.close()	
else:
    print "10"
    ...
    HLStatus.UpdateHLStatus(APID,"Stepid96","Failed","Oracle Kernel Parameter Validation Script Failed, Missing Argument",LogServer,LogDB,LogUser,LogPassword)
