...
my $URL = 'http://192.168.255.169:80/otrs/nph-genericinterface.pl/Webservice/GenericTicketConnector';
...
my $ORACLEServer = $ARGV[3];#'2016082662000041';
my $ScriptDesc1= $ARGV[4];
my $ScriptDesc2= $ARGV[5];
my $ScriptDesc4= $ARGV[6];
my $ScriptDesc5= $ARGV[7];
my $ScriptDesc6= $ARGV[8];
my $ScriptDesc7= $ARGV[9];
my $ScriptDesc8= $ARGV[10];
my $sub="ORACLE UPGRADATION-Oracle Installation process Environmet setup Details";
...
if (@ARGV == 11)
{
	$hcon="<!DOCTYPE html><html lang=\"en\"><body><p>Hi Team,</p><p>This is to inform that  the Oracle_Installation is in progress</p><p>Also find the <b> Environment Setup Details </b> for this process.....</p><table align=\"left\" border=\"1\" cellpadding=\"1\" cellspacing=\"1\" dir=\"ltr\" style=\"width:60%;\">    <thead>    <tr>        <th scope=\"col\" style=\"text-align: left; vertical-align: middle; background-color: rgb(0, 51, 102);\"><span style=\"color:#FFFFFF;\">Components</span></th><th scope=\"col\" style=\"text-align: left; vertical-align: middle; background-color: rgb(0, 0, 102);width: 60%;\"><span style=\"color:#FFFFFF;\">Values</span></th></tr></thead><tbody><tr><td>Oracle Server</td><td>$ORACLEServer</td></tr><tr><td>Binary Details</td><td>$ScriptDesc1</td> </tr><tr>
