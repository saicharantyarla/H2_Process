...
my $sub="ORACLE UPGRADATION-Oracle Installation initiated..";
...
if (@ARGV == 5)
{
	$hcon="<!DOCTYPE html><html lang=\"en\"><body><p>Hi Team,</p><p>This is to inform that  the Oracle_Installation has been initiated(which is a part of <b> ORACLE UPGRADATION</b> process, as requested)</p><p>Also find the <b>Details </b> for this process.....</p><table align=\"left\" border=\"1\" cellpadding=\"1\" cellspacing=\"1\" dir=\"ltr\" style=\"width:60%;\">    <thead>    <tr>        <th scope=\"col\" style=\"text-align: left; vertical-align: middle; background-color: rgb(0, 51, 102);\"><span style=\"color:#FFFFFF;\">Components</span></th><th scope=\"col\" style=\"text-align: left; vertical-align: middle; background-color: rgb(0, 0, 102);width: 60%;\"><span style=\"color:#FFFFFF;\">Values</span></th></tr></thead><tbody><tr><td>Oracle Server</td><td>$ORACLEServer</td></tr><tr><td>Binary Path</td><td>$BinPath</td> </tr>	";
