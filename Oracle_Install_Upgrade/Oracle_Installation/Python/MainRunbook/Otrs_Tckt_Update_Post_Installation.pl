...
my $ScriptDesc9= $ARGV[4];
my $ScriptDesc10= $ARGV[5];
my $ScriptDesc11= $ARGV[6];
my $ScriptDesc12= $ARGV[7];

my $sub="ORACLE UPGRADATION-Oracle Installation process PostCheck Details";
...
if (@ARGV == 8)
{
	$hcon="<!DOCTYPE html><html lang=\"en\"><body><p>Hi Team,</p><p>This is to inform that  the Oracle Installation which is a part of ORACLE Upgradation completed successfully</p><p>Also find the <b> PostCheck  Details </b> for this process.....</p><table align=\"left\" border=\"1\" cellpadding=\"1\" cellspacing=\"1\" dir=\"ltr\" style=\"width:60%;\">    <thead>    <tr>        <th scope=\"col\" style=\"text-align: left; vertical-align: middle; background-color: rgb(0, 51, 102);\"><span style=\"color:#FFFFFF;\">Components</span></th><th scope=\"col\" style=\"text-align: left; vertical-align: middle; background-color: rgb(0, 0, 102);width: 60%;\"><span style=\"color:#FFFFFF;\">Values</span></th></tr></thead><tbody><tr><td>Oracle Server</td><td>$ORACLEServer</td></tr><tr>
        <td> Oracle Installation</td>
        <td>$ScriptDesc9</td>
    </tr>
    <tr>
