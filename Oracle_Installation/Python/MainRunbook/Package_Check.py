...
try:
    ...
    if len(sys.argv) == 10:
        ...
        # Connectivity Test #
        HLStatus.UpdateHLStatus(APID,"Stepid84","In Progress","Installed Packages Check is In Progress",LogServer,LogDB,LogUser,LogPwd)
...
##############################################################################
        ...
        if Package_Notinst==[]:
            if Package_update==[]:
                ...
                #HLStatus.UpdateHLStatus(APID,"Stepid84","Failed","Some Packages Needs to Upgrade",LogServer,LogDB,LogUser,LogPwd)
            ...
            if Package_update==[]:
                ...
                #HLStatus.UpdateHLStatus(APID,"Stepid84","Failed","Some Packages Needs to Install",LogServer,LogDB,LogUser,LogPwd)
        ...
        HLStatus.UpdateHLStatus(APID,"Stepid84","Failed","Package Check Script Failed because of Missing Arguments",LogServer,LogDB,LogUser,LogPwd)
    ...
    HLStatus.UpdateHLStatus(APID,"Stepid84","Failed","Package Check Script Failed",LogServer,LogDB,LogUser,LogPwd)
